                                                                ...
                                                                <tr>
                                                                    <td class="es-m-p0r esd-container-frame" width="180" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-m-p0l es-p15l es-m-txt-c" align="left">
                                                                                        <a href="<?php echo base_url(); ?>" target="_blank"><img src="<?php echo base_url("logo/email.png"); ?>" alt="Petshop logo" title="Petshop logo" width="118"></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-menu" esd-img-prev-h="16" esd-img-prev-w="13">
                                                                                        <table class="es-menu" width="100%" cellspacing="0" cellpadding="0">
                                                                                            <tbody>
                                                                                                <tr class="links">
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l" style="padding-bottom: 10px; padding-top: 20px; " id="esd-menu-id-0" width="25.00%" bgcolor="transparent" align="center"> <a style="color: #333333; font-size: 16px;" href="<?php echo base_url("category/4"); ?>">Accessories</a> </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l" style="border-left: 0px solid #000000; padding-bottom: 10px; padding-top: 20px; " id="esd-menu-id-1" width="25.00%" bgcolor="transparent" align="center"> <a style="color: #333333; font-size: 16px;" href="<?php echo base_url("category/2"); ?>">Kids & Baby</a> </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l" style="border-left: 0px solid #000000; padding-bottom: 10px; padding-top: 20px; " id="esd-menu-id-2" width="25.00%" bgcolor="transparent" align="center"> <a style="color: #333333; font-size: 16px;" href="<?php echo base_url("category/1"); ?>">Tools</a> </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p5t es-p5b es-p40r es-p40l" align="center">
                                                                                        <p style="color: rgb(51, 51, 51);">You'll receive an email when your items are shipped. If you have any questions, Mail us contact@cheapzone.me .<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p15t es-p10b" align="center"> <span class="es-button-border" style="border-radius: 5px; background: rgb(212, 131, 68) none repeat scroll 0% 0%; border-style: solid; border-color: rgb(44, 181, 67); border-top: 0px solid rgb(44, 181, 67); border-bottom: 0px solid rgb(44, 181, 67);"> <a href="<?php echo base_url("home/trackOrder/$idOrder"); ?>" class="es-button" target="_blank" style="font-size: 16px; border-top-width: 10px; border-bottom-width: 10px; border-radius: 5px; background: rgb(212, 131, 68) none repeat scroll 0% 0%; border-color: rgb(212, 131, 68);">View order status</a> </span> </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                                        ...
                                                                                        <table style="width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;"><?php echo $key->id; ?></span></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;">Order Date:</span></td>
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;"><?php echo date("M, d, Y"); ?></span></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;">Order Total:</span></td>
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;">$<?php echo $key->totalPrice; ?></span></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20b es-p20r es-p20l" align="left">
                                                                                        ...
                                                                                        <p><?php echo $key->address2; ?>, <?php echo $this->config->item('countries')[$key->country]; ?></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                    ...
                                    <td class="esd-stripe" esd-custom-block-id="1758" align="center">
                                        <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                            <tbody>
                                                ...
                                                $options = json_decode($key->products);

                                                foreach($options as $cart) {

                                                    $title = get_info("products", $cart->id, "title");
                                                    $img = add_thumb(get_info("products", $cart->id, "images"), "_s");
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image" align="center">
                                                                                        <a href="" target="_blank"><img src="<?php echo base_url("uploads/$img"); ?>" alt="<?php echo $title ?>" class="adapt-img" title="<?php echo $title ?>" width="125"></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td><?php echo $title; ?>
                                                                                                        ...
                                                                                                        <?php if(count($cart->op) > 0){ foreach($cart->op as $g => $d) { 
                                                                                                    ...
                                                                                                    <td style="text-align: center;" width="60"><?php echo $cart->q; ?></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                        <p><br></p>
                                                                                        ...
                                                                                        <table style="width: 500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="right">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="text-align: right; font-size: 18px; line-height: 150%; color: #d48344;"><strong>$<?php echo $key->totalPrice; ?></strong></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                        <p style="line-height: 150%;"><br></p>
