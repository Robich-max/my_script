		  ...
		  <fieldset>
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      ...
		      <div class="col-lg-10 input-grup">
		      	<div class="row">
			        <div class="col-md-5">
			        	<input type="" name="tp[]" placeholder="النوع" class="form-control">
			        </div>
			        <div class="col-md-5">
			        	<input type="" name="info[]" placeholder="الاختيارات المتاحة" class="form-control">
			        </div>
			        <div class="col-md-2">
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      ...
		      <div class="col-lg-10 input-grup">
				...
				foreach($info as $in){
		      	...
		      	<div class="row">
			        <div class="col-md-5">
			        	<input type="" name="tp[]" placeholder="النوع" class="form-control" value="<?php echo $in->tp; ?>">
			        </div>
			        <div class="col-md-5">
			        	<input type="" name="info[]" placeholder="الاختيارات المتاحة" class="form-control" value="<?php echo $in->info; ?>">
			        </div>
			        <div class="col-md-2">
			        	<?php if($i == 0){ ?>
			        		<a style="cursor: pointer;height: 40px;display: block;" onclick="addOptions(this);"><i class="fa fa-plus" style="color: green;"></i></a>
