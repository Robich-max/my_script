    ...
    background-color:<?php echo $settings->rg_bt_color; ?>;
            ...
            <div class="row">
                ...
                <div class="col-md-4 login-form-2">
                    ...
                    <form  method="post" action="<?php echo base_url(); ?>Login/recover_password">
                       
                    <div class="form-group">
                         <label style="color: white;">Enter Email Address</label>
                      <input type="text" name="email" class="form-control" value="<?php echo set_value('user_email'); ?>" placeholder="Your Email *"/>
                        ...
                        <div class="form-group">
                            <input type="submit" class="btnSubmit" value="Send Link" />
                        </div>
                        <div class="form-group">
