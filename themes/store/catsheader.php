...
<meta name="title" content="<?php echo $cats->page_title; ?>" />
 <meta name="og:site_name" content="<?php echo $settings->site_name; ?>" />
  <meta name="og:url" content="<?php echo base_url("home/categorys/$cats->page_url"); ?>" />
  <meta name="og:title" content="Electriclint" />
  <meta name="og:description" content="<?php echo $cats->page_desc; ?>" />

  <title><?php echo $settings->seo_title; ?></title>
  
  <meta name="description" content="<?php echo $cats->page_desc; ?>">
