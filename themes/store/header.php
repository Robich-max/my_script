...
<head>
  ...
  <meta name="title" content="<?php echo $settings->seo_title; ?>" />
  <meta name="og:site_name" content="<?php echo $settings->site_name; ?>" />
  <meta name="og:url" content="https://www.u-childrenteeth.com/" />
  ...
  <style>
    ...
    .bgwhites {
      background-color: <?php echo $settings->bar_info_color; ?>;
    }
    ...
    .w-size1 {
      <?php echo $settings->home_btn; ?>: auto;
    }
    ...
    .jumbotron {
      ...
      background-color: <?php echo $settings->thanks_page_color; ?>;
      ...
      <div class="wrap_header">
        ...
        <div class="header-icons">
          <?php if (!$this->session->userdata('id')) { ?>
            <a href="<?php echo base_url("home/account"); ?>" class="nav-item"> <img src="logo/<?php echo $settings->account_logo; ?>" class="header-icon1 js-show-header-dropdown" alt="ICON" style="height: <?php echo $settings->account_logo_height; ?>px;">
            </a>
          <?php } else { ?>
                    ...
                    <?php foreach ($cart as $kt => $kc) : ?>
                      <li class="header-cart-item">
                        ...
                        <div class="header-cart-item-txt">
                          ...
                          <span class="header-cart-item-info"><?php echo $kc['q']; ?> x <span class="currency" data-currencyName="usd"><?php echo $kc['price']; ?></span>
                          </span>
                        </div>
                      </li>
                    <?php endforeach; ?>
        ...
        <div class="wrap-side-menu">
          ...
          <div class="topbar top-bar-style1" style="background-color: <?php echo $settings->bg_color; ?>; height: <?php echo $settings->height . 'px'; ?>; ">
            ...
            <div class="topbar-child2">
              ...
              <div class="google_translate_elements"></div>
