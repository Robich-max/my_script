...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
	  <meta name="title" content="<?php echo $info->page_title; ?>" />
 <meta name="og:site_name" content="<?php echo $settings->site_name; ?>" />
  <meta name="og:url" content="<?php echo base_url("page/$info->slug"); ?>" />
  <meta name="og:title" content="Electriclint" />
  <meta name="og:description" content="<?php echo $info->page_desc; ?>" />

  <title><?php echo $settings->seo_title; ?></title>
  
  <meta name="description" content="<?php echo $info->page_desc; ?>">
					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
								...
								<li class="header-cart-item">
									...
									<div class="header-cart-item-txt">
										...
										<span class="header-cart-item-info">
											<span class="cartItem<?=$kt;?>"><?php echo $kc['q']; ?></span> x $<?php echo $kc['price']; ?>
											<?php if($kc['price'] != $kc['orp']){ ?><del style="color: red"><?php echo $kc['orp']; ?> $</del><?php } ?>
										</span>
									</div>
								</li>
								<?php endforeach; ?>
							...
							<div class="header-cart-total">
								<?php echo lang("lang_h6") ?> Price: $<?php echo $tprice; ?>
							</div>
