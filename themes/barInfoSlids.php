						...
						<div class="card-body">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<input type="color" name="slids_bg_color" value="<?php echo $key->slids_bg_color; ?>" class="form-control">
								</div>
								
								<div class="form-group">
									<label for="inp1">Slids Font Color </label>
									<input type="color" name="slids_ft_color" value="<?php echo $key->slids_ft_color; ?>" class="form-control">
								</div>
