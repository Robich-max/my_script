	...
	<div id="content">
		...
		<div class="container-fluid">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<?php if(isset($msg)){ ?>
					<div class="alert alert-success">the blog has been successfully added .</div>
					<?php } ?>
					<fieldset>
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="inp1">Blog <?=lang("admin_h179");?></label>
									<input type="file" name="img" class="form-control-file" >
									<small id="emailHelp" class="form-text text-muted"></small>
									<br/>
								</div>
								<div class="form-group">
									<label for="inp1">Banner <?=lang("admin_h179");?></label>
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				...
				<a href="<?php echo base_url("admin/add_blogPage"); ?>" class="btn btn-success btn-icon-split btn-sm float-right">
			...
			<div class="card-body">
				<ul id="responds" class="list-group">
					<?php foreach($blog as $key) { $idcat = $key->id; ?>
					<li id="slider_<?php echo $idcat; ?>" class="list-group-item border-left-primary" style="margin-bottom: 10px;">
						...
						<div class="del_wrapper" style="float: right;">
							<a href="<?php echo base_url("admin/edit_blogPage/$key->id"); ?>" class="btn btn-primary btn-icon-split btn-sm">
								<span class="icon text-white-50">
									<i class="fas fa-edit"></i>
								</span>
								
							</a>
							<a href="<?php echo base_url("admin/delt/blog/$key->id/blogPage"); ?>" class="btn btn-danger btn-icon-split btn-sm">
								<span class="icon text-white-50">
