                        ...
                        function drawChart() {
                          var data = google.visualization.arrayToDataTable([
                            ...
                            // ["Platinum", 21.45, "color: #e5e4e2"]
                                ...
                                <?php if ($value == "counter"){ ?>
                                ["Time", "Counter", { role: "style" } ],
            			            <?php foreach ($chart_data as $data){ ?>
                			                ["<?php echo gmdate("h a" ,$data->date); ?>", <?php if($action == "visitors") { echo $data->id; } else { echo $data->pageViews; } ?>, "color: #1cc88a"],
        			                <?php }
            			        } elseif ($value == "orders") { ?>
            			        ["Time", "Price", { role: "style" } ],
            			            <?php foreach ($chart_data as $data) { ?>
            			                ["<?php echo gmdate("h a" ,$data->date); ?>", <?php echo $data->totalPrice ?>, "color: #1cc88a"],
            			            <?php }
